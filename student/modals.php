            ...
            <form class="needs-validation" novalidate action="<?= basedir ?>student/student-actions.php" method="post" enctype="multipart/form-data">
                <div class="modal-body text-left align-middle">
                    ...
                    <div class="alert alert-primary" role="alert">
                        Διορθώστε στοιχεία του μαθητή που θέλετε και πατήστε αποθήκευση.
                    </div>
        ...
        <div class="modal-content">
            ...
            <form class="needs-validation" novalidate action="student-actions.php" method="post" >
                ...
                <div class="modal-footer d-flex justify-content-center">
                    ...
                    <button type="submit" name="create_payment" class="btn btn-success border-button"><i class="fas fa-save"></i>&nbsp&nbspΑποθήκευση</button>
                </div>
...
<div class="modal fade" id="add-cost-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Διαχείριση κόστους</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form action="student-actions.php" method="post">
                <div class="modal-body">
                    <div class="alert alert-primary" role="alert">
                        Παρακάτω μπορείτε να διαχειριστείτε το κόστος χρέωσης.
                    </div>
                ...
                <div class="modal-footer d-flex justify-content-center">
                    <button type="button" class="btn btn-danger border-button" data-dismiss="modal"><i class="fas fa-times-circle"></i>&nbsp&nbspΑκύρωση</button>
                    <button type="submit" name="update_cost_modal_submit_button" class="btn btn-success border-button"><i class="fas fa-save"></i>&nbsp&nbspΑποθήκευση</button>
                </div>
            </form>
        </div>
    </div>
